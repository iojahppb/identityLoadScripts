...
declare namespace load {
    ...
    export class GrpcClient {
         ...
         * The options must include at least a _method_ and _protoFile_ properties which is mandatory, while all the other properties are optional.
         *
    ...
    export class GrpcUnaryRequest {
        /**
         * Performs unary RPC to a gRPC server. When called, the script execution is blocked until a response or error is returned. Returns the resulting _GrpcResponse_ object, or throws an exception.
         *
